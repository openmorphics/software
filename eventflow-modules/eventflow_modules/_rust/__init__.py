"""
Optional Rust acceleration loader for eventflow-modules (vision kernels).
...
if _env is True and _native is None:
    warnings.warn(
        "EF_NATIVE=1 set but eventflow_modules vision native extension failed to import; "
...
def is_enabled() -> bool:
    """
    Determine if native acceleration should be used for eventflow-modules.
    """
    env = _env_toggle()
    if env is True:
