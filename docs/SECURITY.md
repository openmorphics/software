...
Scope
- Kernel sandboxing baseline for v0.1: process isolation for custom kernels.
- Advanced kernel hardening (seccomp profiles and container-level sandboxing) is an accepted v0.1 deferral and tracked for post-v0.1 hardening.
